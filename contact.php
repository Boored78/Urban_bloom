            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 contact-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <p class="mb-4">Contact us if you have any questions. We will respond to you in the next 48 hours</a>.</p>
                        <div class="modal-content">
                        <form action="process_contact.php" method="POST">
                            <input type="email" name="email" placeholder="Your Email" required>
                            <textarea name="message" placeholder="Your Message" rows="5" required></textarea>
                            <button style="margin-top: 20px;" type="submit">Send Inquiry</button>
                        </form>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 pe-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        ...
                        src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=%20123th%20Street,%20New%20York,%20USA+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
